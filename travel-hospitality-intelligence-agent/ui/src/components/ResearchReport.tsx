          ...
          <ReactMarkdown
            ...
            components={{
              ...
              h1: ({node, children, ...props}) => (
                <h1 className="font-bold text-gray-900 break-words whitespace-pre-wrap text-2xl sm:text-3xl mb-6 mt-4" {...props}>
                  {children}
                </h1>
              ),
              h2: ({node, ...props}) => (
              ...
              p: ({node, children, ...props}) => (
                <p className="text-gray-800 my-2" {...props}>{children}</p>
              ),
              ul: ({node, ...props}) => (
