  ...
  <header>
    <nav className="site-nav setup-header" aria-label="Main navigation">
      ...
      <div className="nav-actions">
        <a
          href="https://github.com/tavily-ai/tavily-industry-demos/tree/main/travel-hospitality-intelligence-agent"
          target="_blank"
          rel="noopener noreferrer"
          className="nav-link"
    ...
    <div className="hero">
      ...
      <p className="hero-description">
        Explore destination demand, pricing, events, traveler sentiment, and disruptions in a
        research brief for travel and hospitality planning.
      </p>
    </div>
  </header>
);
