...
type BriefingStatus = Record<LaneKey, boolean>;
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between cursor-pointer" onClick={onToggleExpand}>
        <h2 className="text-xl font-semibold text-gray-900">Research Briefings</h2>
            ...
            >
              <div
                className={`absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(70,139,255,0.15),transparent_70%)] opacity-0 transition-opacity duration-700 ease-in-out rounded-lg ${
                  briefingStatus[category] ? "opacity-100" : ""
                }`}
