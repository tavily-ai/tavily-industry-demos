...
const CATEGORY_LABELS: Record<string, string> = {
  destination_analyzer: "demand",
  trends_analyzer: "trends",
  pricing_analyzer: "pricing",
  disruptions_analyzer: "disruptions",
  destination: "demand",
  trends: "trends",
  pricing: "pricing",
...
function categoryLabel(category: string) {
  return CATEGORY_LABELS[category] || category.split("_")[0] || category;
}
