...
app = FastAPI(title="Tavily Travel Intelligence API")
...
class ResearchRequest(BaseModel):
    destination: str
    travel_segment: str | None = None
    research_priorities: str | None = None
...
async def research(data: ResearchRequest):
    try:
        logger.info(f"Received travel intelligence request for {data.destination}")
...
async def process_research(job_id: str, data: ResearchRequest):
    ...
    try:
        ...
        logger.info(f"Starting travel intelligence research for {data.destination}")

        graph = Graph(
            company=data.destination,
            industry=data.travel_segment,
            research_priorities=data.research_priorities,
            job_id=job_id,
        ...
        if report_content:
            ...
            logger.info(f"Travel intelligence research completed successfully for {data.destination}")
        else:
