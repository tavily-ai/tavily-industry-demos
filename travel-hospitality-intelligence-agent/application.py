...
async def process_research(job_id: str, data: ResearchRequest):
    try:
        logger.info("Starting travel intelligence for %s", data.destination)
        graph = Graph(
            destination=data.destination,
            travel_segment=data.travel_segment,
        ...
        if report_content:
            ...
            logger.info("Research completed successfully for %s", data.destination)
            return
