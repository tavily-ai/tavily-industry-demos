...
class Briefing:
    ...
    def _get_category_prompt(self, category: str) -> str:
        ...
        prompts = {
            'company': DESTINATION_BRIEFING_PROMPT,
            'industry': INDUSTRY_BRIEFING_PROMPT,
            'financial': FINANCIAL_BRIEFING_PROMPT,
            'news': NEWS_BRIEFING_PROMPT,
        }
        return prompts.get(category, 
                          "Create a focused, informative travel intelligence briefing about destination {company} based on the provided documents.")
    ...
    async def generate_category_briefing(
        ...
        research_priorities = context.get('research_priorities', 'Unknown')
        ...
        category_prompt = self._get_category_prompt(category).format(
            company=company, industry=industry, research_priorities=research_priorities
        )
...
{documents}""")
    ...
    async def create_briefings(self, state: ResearchState) -> ResearchState:
        ...
        context = {
            ...
            "research_priorities": state.get('research_priorities', 'Unknown'),
