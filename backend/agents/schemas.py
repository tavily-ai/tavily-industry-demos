...
class EvidenceItem(BaseModel):
    ...
    date: Optional[str] = Field(default=None, description="Publication date of the article if known")
...
class Finding(BaseModel):
    ...
    date: Optional[str] = Field(default=None, description="Date of the event or article")
...
class CaseFile(BaseModel):
    ...
    naics_code: Optional[str] = Field(default=None, description="NAICS industry classification code")
    industry: Optional[str] = Field(default=None, description="Primary industry")
    country: Optional[str] = Field(default=None, description="Country of incorporation / headquarters")
