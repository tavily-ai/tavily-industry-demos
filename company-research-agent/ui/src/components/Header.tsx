  ...
  <header>
    <nav className="site-nav setup-header" aria-label="Main navigation">
      ...
      <div className="nav-actions">
        <a
          href="https://github.com/tavily-ai/tavily-industry-demos/tree/main/company-research-agent"
          target="_blank"
          rel="noopener noreferrer"
          className="nav-link"
    ...
    <div className="hero">
      ...
      <p className="hero-description">
        Research a company's business, industry, financial context, and recent news, then explore a
        detailed briefing with linked sources and PDF export.
      </p>
    </div>
  </header>
);
