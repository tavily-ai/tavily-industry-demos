...
The tests use mock upstream responses and cover parallel execution, stream framing, cancellation, validation, citations, and credential redaction. They do not consume API credits. GitHub Actions runs lint, format check, tests, and a production build on pushes and pull requests.
